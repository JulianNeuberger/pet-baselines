...
def test_do_augment():
    ...
    tokens = [model.Token(text="I", index_in_document=0, pos_tag="VB", bio_tag="", sentence_index=0),
              model.Token(text="am", index_in_document=1, pos_tag="VBP", bio_tag="", sentence_index=0),
              model.Token(text="the", index_in_document=2, pos_tag="VB", bio_tag="", sentence_index=0),
              model.Token(text="Head", index_in_document=3, pos_tag="NN", bio_tag="", sentence_index=0),
              model.Token(text="of", index_in_document=4, pos_tag="VB", bio_tag="", sentence_index=0),
              model.Token(text="the", index_in_document=5, pos_tag="DT", bio_tag="", sentence_index=0),
              model.Token(text="department", index_in_document=6, pos_tag="VB", bio_tag="", sentence_index=0),
